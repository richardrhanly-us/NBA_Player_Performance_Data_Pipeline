...
<div class="hero">
    ...
    <p class="hero-subtitle">Search a player, pull the latest line, and compare it to the rediction. This application is for Machine learning purposes only. Gamble at your own risk. model.</p>
